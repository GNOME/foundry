 ...
 * plugin.c
 *
 * Copyright 2026 Christian Hergert <christian@redhat.com>
 *
...
FOUNDRY_PLUGIN_DEFINE (_plugin_codex_acp_register_types,
                       FOUNDRY_PLUGIN_REGISTER_TYPE (FOUNDRY_TYPE_ACP_PROVIDER,
                                                    PLUGIN_TYPE_CODEX_ACP_PROVIDER)
                       FOUNDRY_PLUGIN_REGISTER_TYPE (FOUNDRY_TYPE_BUILD_ADDIN,
                                                    PLUGIN_TYPE_CODEX_BUILD_ADDIN))
