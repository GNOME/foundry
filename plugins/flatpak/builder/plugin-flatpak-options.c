...
G_DEFINE_FINAL_TYPE (PluginFlatpakOptions, plugin_flatpak_options, PLUGIN_TYPE_FLATPAK_SERIALIZABLE)

static DexFuture *
plugin_flatpak_options_deserialize_property (PluginFlatpakSerializable *serializable,
                                             const char                *property_name,
                                             JsonNode                  *property_node)
{
  PluginFlatpakOptions *self = PLUGIN_FLATPAK_OPTIONS (serializable);
  ...
  return PLUGIN_FLATPAK_SERIALIZABLE_CLASS (plugin_flatpak_options_parent_class)->
...
plugin_flatpak_options_class_init (PluginFlatpakOptionsClass *klass)
{
  ...
  serializable_class->deserialize_property = plugin_flatpak_options_deserialize_property;
  ...
  g_object_class_install_property (object_class,
                                   ...
                                   g_param_spec_object ("arch",
                                                        NULL,
                                                        NULL,
                                                        PLUGIN_TYPE_FLATPAK_ARCH_OPTIONS,
                                                        G_PARAM_READWRITE | G_PARAM_STATIC_STRINGS));
  g_object_class_install_property (object_class,
                                   PROP_BUILD_ARGS,
...
char **
plugin_flatpak_options_dup_build_args (PluginFlatpakOptions *self)
{
...
char *
plugin_flatpak_options_dup_append_path (PluginFlatpakOptions *self)
{
  g_return_val_if_fail (PLUGIN_IS_FLATPAK_OPTIONS (self), NULL);
...
char *
plugin_flatpak_options_dup_prepend_path (PluginFlatpakOptions *self)
{
  g_return_val_if_fail (PLUGIN_IS_FLATPAK_OPTIONS (self), NULL);
