...
struct _PluginFlatpakSourceGit
{
...
G_DEFINE_FINAL_TYPE (PluginFlatpakSourceGit, plugin_flatpak_source_git, PLUGIN_TYPE_FLATPAK_SOURCE)

static void
plugin_flatpak_source_git_finalize (GObject *object)
{
  PluginFlatpakSourceGit *self = (PluginFlatpakSourceGit *)object;
  ...
  G_OBJECT_CLASS (plugin_flatpak_source_git_parent_class)->finalize (object);
}

static void
plugin_flatpak_source_git_get_property (GObject    *object,
                                        guint       prop_id,
                                        GValue     *value,
                                        GParamSpec *pspec)
{
  PluginFlatpakSourceGit *self = PLUGIN_FLATPAK_SOURCE_GIT (object);
...
static void
plugin_flatpak_source_git_set_property (GObject      *object,
                                        guint         prop_id,
                                        const GValue *value,
                                        GParamSpec   *pspec)
{
...
static void
plugin_flatpak_source_git_init (PluginFlatpakSourceGit *self)
{
}
