...
struct _PluginFlatpakExtension
{
...
G_DEFINE_FINAL_TYPE (PluginFlatpakExtension, plugin_flatpak_extension, PLUGIN_TYPE_FLATPAK_SERIALIZABLE)

static void
plugin_flatpak_extension_finalize (GObject *object)
{
  PluginFlatpakExtension *self = (PluginFlatpakExtension *)object;
  ...
  G_OBJECT_CLASS (plugin_flatpak_extension_parent_class)->finalize (object);
}

static void
plugin_flatpak_extension_get_property (GObject    *object,
                                       guint       prop_id,
                                       GValue     *value,
                                       GParamSpec *pspec)
{
  PluginFlatpakExtension *self = PLUGIN_FLATPAK_EXTENSION (object);
...
static void
plugin_flatpak_extension_set_property (GObject      *object,
                                       guint         prop_id,
                                       const GValue *value,
                                       GParamSpec   *pspec)
{
...
static void
plugin_flatpak_extension_class_init (PluginFlatpakExtensionClass *klass)
{
  GObjectClass *object_class = G_OBJECT_CLASS (klass);

  object_class->finalize = plugin_flatpak_extension_finalize;
  object_class->get_property = plugin_flatpak_extension_get_property;
  object_class->set_property = plugin_flatpak_extension_set_property;
...
static void
plugin_flatpak_extension_init (PluginFlatpakExtension *self)
{
}
