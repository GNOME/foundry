...
static const PluginGobjectCodeTemplateInfo templates[] = {
  ...
  {
    "gtkwidget",
    N_("Create a new GtkWidget"),
    (PluginGobjectCodeTemplateInput[]) {
      { "filename",
        N_("File Name"),
        N_("The base for the filename such as “my-widget”"),
        INPUT_KIND_TEXT,
        "^[\\w\\-_]+$",
        "my-widget",
      },
      ...
      { "classname",
        N_("Class Name"),
        N_("The class name in title case such as “Widget”"),
        INPUT_KIND_TEXT,
        "^\\w+$",
        "Widget",
      },
      { "parentclass",
        N_("Parent Class"),
        N_("The parent class in title case such as “GtkWidget”"),
        INPUT_KIND_TEXT,
        "^\\w+$",
        "GtkWidget",
      },
