...
static int
foundry_cli_builtin_llm_list_resources_run (FoundryCommandLine *command_line,
                                            ...
                                            DexCancellable     *cancellable)
{
  ...
  if (!(list = dex_await_object (foundry_llm_manager_list_resources (llm_manager), &error)))
    goto handle_error;
  ...
  foundry_command_line_print_list (command_line, list, fields, format, FOUNDRY_TYPE_LLM_RESOURCE);
...
void
foundry_cli_builtin_llm_list_resources (FoundryCliCommandTree *tree)
{
  foundry_cli_command_tree_register (tree,
                                     FOUNDRY_STRV_INIT ("foundry", "llm", "list-resources"),
                                     &(FoundryCliCommand) {
                                       ...
                                       .run = foundry_cli_builtin_llm_list_resources_run,
                                       .prepare = NULL,
                                       .complete = NULL,
                                       .gettext_package = GETTEXT_PACKAGE,
                                       .description = N_("List available resources"),
                                     });
}
