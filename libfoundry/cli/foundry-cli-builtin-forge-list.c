...
static int
foundry_cli_builtin_forge_list_run (FoundryCommandLine *command_line,
                                    ...
                                    DexCancellable     *cancellable)
{
  ...
  foundry_command_line_print_list (command_line, G_LIST_MODEL (forge_manager), fields, format, FOUNDRY_TYPE_FORGE);
...
void
foundry_cli_builtin_forge_list (FoundryCliCommandTree *tree)
{
  foundry_cli_command_tree_register (tree,
                                     FOUNDRY_STRV_INIT ("foundry", "forge", "list"),
                                     &(FoundryCliCommand) {
                                       ...
                                       .run = foundry_cli_builtin_forge_list_run,
                                       .prepare = NULL,
                                       .complete = NULL,
                                       .gettext_package = GETTEXT_PACKAGE,
                                       .description = N_("List available forges"),
                                     });
}
