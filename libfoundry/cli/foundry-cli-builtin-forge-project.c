...
static int
foundry_cli_builtin_forge_project_run (FoundryCommandLine *command_line,
                                       ...
                                       DexCancellable     *cancellable)
{
  ...
  foundry_command_line_print_object (command_line, G_OBJECT (project), fields, format);
...
void
foundry_cli_builtin_forge_project (FoundryCliCommandTree *tree)
{
  foundry_cli_command_tree_register (tree,
                                     FOUNDRY_STRV_INIT ("foundry", "forge", "project"),
                                     &(FoundryCliCommand) {
                                       ...
                                       .run = foundry_cli_builtin_forge_project_run,
                                       .prepare = NULL,
                                       .complete = NULL,
