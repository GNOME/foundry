...
static int
foundry_cli_builtin_forge_merge_requests_list_run (FoundryCommandLine *command_line,
                                                   ...
                                                   DexCancellable     *cancellable)
{
  ...
  foundry_command_line_print_list (command_line, G_LIST_MODEL (results), fields, format, FOUNDRY_TYPE_FORGE_MERGE_REQUEST);
...
void
foundry_cli_builtin_forge_merge_requests_list (FoundryCliCommandTree *tree)
{
