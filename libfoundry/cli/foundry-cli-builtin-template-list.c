                                       ...
                                       DexCancellable     *cancellable)
{
  ...
  if (!(templates = dex_await_object (foundry_template_manager_list_project_templates (template_manager), &error)))
    goto handle_error;
  ...
  foundry_command_line_print_list (command_line, G_LIST_MODEL (templates), fields, format, FOUNDRY_TYPE_PROJECT_TEMPLATE);
