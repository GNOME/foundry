/* foundry-cli-builtin-pipeline-link-workspace.c
 *
...
static int
foundry_cli_builtin_pipeline_link_workspace_run (FoundryCommandLine *command_line,
...
void
foundry_cli_builtin_pipeline_link_workspace (FoundryCliCommandTree *tree)
{
  foundry_cli_command_tree_register (tree,
                                     FOUNDRY_STRV_INIT ("foundry", "pipeline", "link-workspace"),
                                     &(FoundryCliCommand) {
                                       .options = (GOptionEntry[]) {
                                         { "help", 0, 0, G_OPTION_ARG_NONE },
                                         {0}
                                       },
                                       .run = foundry_cli_builtin_pipeline_link_workspace_run,
