...
#define FOUNDRY_TYPE_INPUT_PASSWORD (foundry_input_password_get_type())

FOUNDRY_AVAILABLE_IN_ALL
G_DECLARE_DERIVABLE_TYPE (FoundryInputPassword, foundry_input_password, FOUNDRY, INPUT_PASSWORD, FoundryInput)

struct _FoundryInputPasswordClass
{
