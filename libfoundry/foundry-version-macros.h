...
#define FOUNDRY_VERSION_1_2 (G_ENCODE_VERSION (1, 2))
#define FOUNDRY_VERSION_1_3 (G_ENCODE_VERSION (1, 3))
...
#if FOUNDRY_VERSION_MIN_REQUIRED >= FOUNDRY_VERSION_1_2
# define FOUNDRY_DEPRECATED_IN_1_2 FOUNDRY_DEPRECATED
# define FOUNDRY_DEPRECATED_IN_1_2_FOR(f) FOUNDRY_DEPRECATED_FOR(f)
#else
# define FOUNDRY_DEPRECATED_IN_1_2 _FOUNDRY_EXTERN
# define FOUNDRY_DEPRECATED_IN_1_2_FOR(f) _FOUNDRY_EXTERN
#endif
#if FOUNDRY_VERSION_MAX_ALLOWED < FOUNDRY_VERSION_1_2
# define FOUNDRY_AVAILABLE_IN_1_2 FOUNDRY_UNAVAILABLE(1, 2)
#else
# define FOUNDRY_AVAILABLE_IN_1_2 _FOUNDRY_EXTERN
#endif

#if FOUNDRY_VERSION_MIN_REQUIRED >= FOUNDRY_VERSION_1_3
# define FOUNDRY_DEPRECATED_IN_1_3 FOUNDRY_DEPRECATED
# define FOUNDRY_DEPRECATED_IN_1_3_FOR(f) FOUNDRY_DEPRECATED_FOR(f)
#else
# define FOUNDRY_DEPRECATED_IN_1_3 _FOUNDRY_EXTERN
# define FOUNDRY_DEPRECATED_IN_1_3_FOR(f) _FOUNDRY_EXTERN
#endif
#if FOUNDRY_VERSION_MAX_ALLOWED < FOUNDRY_VERSION_1_3
# define FOUNDRY_AVAILABLE_IN_1_3 FOUNDRY_UNAVAILABLE(1, 3)
#else
# define FOUNDRY_AVAILABLE_IN_1_3 _FOUNDRY_EXTERN
#endif
