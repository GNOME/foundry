...
#define FOUNDRY_VERSION_CUR_STABLE (G_ENCODE_VERSION (FOUNDRY_MAJOR_VERSION, 0))
...
#else
# define FOUNDRY_VERSION_PREV_STABLE (G_ENCODE_VERSION (FOUNDRY_MAJOR_VERSION - 1, 0))
#endif
