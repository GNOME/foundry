...
#define FOUNDRY_TYPE_VCS_REMOTE (foundry_vcs_remote_get_type())

FOUNDRY_AVAILABLE_IN_ALL
G_DECLARE_DERIVABLE_TYPE (FoundryVcsRemote, foundry_vcs_remote, FOUNDRY, VCS_REMOTE, GObject)

struct _FoundryVcsRemoteClass
{
