...
struct _FoundryVcsClass
{
  ...
  DexFuture *(*load_graph)             (FoundryVcs            *self,
                                        ...
                                        guint                  limit);
  DexFuture *(*resolve_revision)       (FoundryVcs            *self,
                                        const char            *revspec);
  DexFuture *(*diff_full)              (FoundryVcs            *self,
...
DexFuture *foundry_vcs_diff_full              (FoundryVcs            *self,
                                               FoundryVcsRevision    *old_revision,
                                               FoundryVcsRevision    *new_revision,
...
DexFuture *foundry_vcs_query_file_status      (FoundryVcs            *self,
                                               GFile                 *file) G_GNUC_WARN_UNUSED_RESULT;
FOUNDRY_AVAILABLE_IN_1_3
DexFuture *foundry_vcs_resolve_revision       (FoundryVcs            *self,
