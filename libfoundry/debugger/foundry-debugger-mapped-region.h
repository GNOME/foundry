/* foundry-debugger-mapped-region.h
 *
...
#define FOUNDRY_TYPE_DEBUGGER_MAPPED_REGION (foundry_debugger_mapped_region_get_type())

FOUNDRY_AVAILABLE_IN_ALL
G_DECLARE_DERIVABLE_TYPE (FoundryDebuggerMappedRegion, foundry_debugger_mapped_region, FOUNDRY, DEBUGGER_MAPPED_REGION, GObject)

struct _FoundryDebuggerMappedRegionClass
{
