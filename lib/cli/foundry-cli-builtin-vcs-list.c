                                  ...
                                  DexCancellable     *cancellable)
{
  ...
  foundry_command_line_print_list (command_line, G_LIST_MODEL (vcs_manager), fields, format, G_TYPE_INVALID);
...
void
foundry_cli_builtin_vcs_list (FoundryCliCommandTree *tree)
{
  foundry_cli_command_tree_register (tree,
                                     FOUNDRY_STRV_INIT ("foundry", "vcs", "list"),
                                     &(FoundryCliCommand) {
                                       ...
                                       .run = foundry_cli_builtin_vcs_list_run,
                                       .prepare = NULL,
                                       .complete = NULL,
                                       .gettext_package = GETTEXT_PACKAGE,
                                       .description = N_("List available version control systems"),
                                     });
}
