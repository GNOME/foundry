...
static char **
foundry_cli_builtin_sdk_install_complete (FoundryCommandLine *command_line,
                                          const char         *command,
                                          ...
                                          const char         *current)
{
  return foundry_cli_builtin_complete_list_model (options, command_line, argv, current, "sdk-manager", "id");
}

static int
foundry_cli_builtin_sdk_install_run (FoundryCommandLine *command_line,
                                     const char * const *argv,
                                     FoundryCliOptions  *options,
                                     DexCancellable     *cancellable)
{
  ...
  if (sdk_id == NULL)
    {
      foundry_command_line_printerr (command_line, "usage: foundry sdk install SDK_ID\n");
      return EXIT_FAILURE;
    }
  ...
  operation = foundry_operation_manager_begin (operation_manager, _("Installing SDK"));
