...
foundry_command_line_help (FoundryCommandLine *self)
{
  ...
  foundry_command_line_print (self, "  profiler         %s\n", _("Run a project commmnd in the profiler"));
  ...
  foundry_command_line_print (self, "  diagnostics      %s\n", _("List diagnostics within a file"));
  foundry_command_line_print (self, "\n");
  foundry_command_line_print (self, "%s:\n", _("SDK Commands"));
  ...
  foundry_command_line_print (self, "\n");
  foundry_command_line_print (self, "  # Entry foundry environment\n");
