...
static void
foundry_cli_builtin_config_list_help (FoundryCommandLine *command_line)
{
  g_assert (FOUNDRY_IS_COMMAND_LINE (command_line));

  foundry_command_line_print (command_line, "Usage:\n");
  foundry_command_line_print (command_line, "  foundry config list [OPTIONS…]\n");
...
static int
foundry_cli_builtin_config_list_run (FoundryCommandLine *command_line,
                                     ...
                                     DexCancellable     *cancellable)
{
  ...
  if (foundry_cli_options_help (options))
    {
      foundry_cli_builtin_config_list_help (command_line);
      return EXIT_SUCCESS;
    }
  ...
  foundry_command_line_print_list (command_line, G_LIST_MODEL (config_manager), fields, format, G_TYPE_INVALID);
...
void
foundry_cli_builtin_config_list (FoundryCliCommandTree *tree)
{
  foundry_cli_command_tree_register (tree,
                                     FOUNDRY_STRV_INIT ("foundry", "config", "list"),
                                     &(FoundryCliCommand) {
                                       ...
                                       .run = foundry_cli_builtin_config_list_run,
                                       .prepare = NULL,
                                       .complete = NULL,
