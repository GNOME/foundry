...
static void
foundry_file_manager_finalize (GObject *object)
{
  FoundryFileManager *self = (FoundryFileManager *)object;

  G_OBJECT_CLASS (foundry_file_manager_parent_class)->finalize (object);
}
...
foundry_file_manager_class_init (FoundryFileManagerClass *klass)
{
  ...
  object_class->finalize = foundry_file_manager_finalize;
